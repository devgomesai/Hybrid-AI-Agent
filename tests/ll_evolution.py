...
async def phase1_current_llms(graphiti):
    ...
    episodes = [
        {
            'content': f'GPT-4.1 was released by OpenAI on April 14, 2025. It features improved capabilities in coding, instruction following, and long-context processing with a knowledge as of {datetime.now()}',
