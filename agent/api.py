...
async def search_web(
    ...
    """Web search endpoint using Perplexity AI."""
    try:
...
async def get_entity_timeline_endpoint(
    ...
    try:
        ...
        timeline = await get_entity_timeline_tool(input_data)
        ...
        logger.error(f"Entity timeline retrieval failed: {e}")
        raise HTTPException(status_code=500, detail=str(e))
