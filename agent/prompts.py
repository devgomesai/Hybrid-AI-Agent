...
3. **Web Search**: Ability to find the latest information from the web if its not available
4. **Hybrid Search**: Combining both vector and graph searches for comprehensive results
...
- Use web search for finding the latest information if not available
